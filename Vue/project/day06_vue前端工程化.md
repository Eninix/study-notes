- [今日目标](#今日目标)
- [1.模块化的分类](#1模块化的分类)
	- [A.浏览器端的模块化](#a浏览器端的模块化)
	- [B.服务器端的模块化](#b服务器端的模块化)
	- [C.ES6模块化](#ces6模块化)
- [2.在NodeJS中安装babel](#2在nodejs中安装babel)
	- [A.安装babel](#a安装babel)
	- [B.创建babel.config.js](#b创建babelconfigjs)
	- [C.创建index.js文件](#c创建indexjs文件)
	- [D.使用npx执行文件](#d使用npx执行文件)
- [3.设置默认导入/导出](#3设置默认导入导出)
	- [A.默认导出](#a默认导出)
	- [B.默认导入](#b默认导入)
- [4.设置按需导入/导出](#4设置按需导入导出)
	- [A.按需导出](#a按需导出)
	- [B.按需导入](#b按需导入)
- [5.直接导入并执行代码](#5直接导入并执行代码)
- [6.webpack的概念](#6webpack的概念)
- [7.webpack的基本使用](#7webpack的基本使用)
	- [A.创建项目目录并初始化](#a创建项目目录并初始化)
	- [B.创建首页及js文件](#b创建首页及js文件)
	- [C.安装jQuery](#c安装jquery)
	- [D.导入jQuery](#d导入jquery)
	- [E.安装webpack](#e安装webpack)
- [8.设置webpack的打包入口/出口](#8设置webpack的打包入口出口)
- [9.设置webpack的自动打包](#9设置webpack的自动打包)
- [10.配置html-webpack-plugin](#10配置html-webpack-plugin)
- [11.webpack中的加载器](#11webpack中的加载器)
- [12.Vue单文件组件](#12vue单文件组件)
- [13.在webpack中使用vue](#13在webpack中使用vue)
- [14.使用webpack打包发布项目](#14使用webpack打包发布项目)
- [15.Vue脚手架](#15vue脚手架)
- [16.Vue脚手架的自定义配置](#16vue脚手架的自定义配置)
- [17.Element-UI的基本使用](#17element-ui的基本使用)
